...
public class BookListAdapter extends RecyclerView.Adapter<BookListAdapter.ViewHolder>{
    ...
    public BookListAdapter(Context context, List<BookModel> bookList, BookCallBack callBack) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imgContainer = itemView.findViewById(R.id.bcg_book);
            imageBook = itemView.findViewById(R.id.book_cover_img);
