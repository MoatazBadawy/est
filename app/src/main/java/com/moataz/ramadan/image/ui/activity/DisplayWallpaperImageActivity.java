package com.moataz.ramadan.image.ui.activity;
 ...
 */
public class DisplayWallpaperImageActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_wallpaper_images);
        ...
        if (intent.hasExtra("imageWallpaperUrl")) {
            String url = intent.getStringExtra("imageWallpaperUrl");
            Glide
                    .with(this)
                    .load(url)
